"""
Django settings for documentverifier project.
...
SECRET_KEY = 'gr0qp#shu%3p=qsg_y@bmz!b6(5-^cs9#ka^x!p@pbixs@+-^c'
...
ROOT_URLCONF = 'documentverifier.urls'
...
WSGI_APPLICATION = 'documentverifier.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "verifier", "static")]